...
export default function Controls({
  ...
  panelStatus: "annotations" | "ordinary" | "colors";
  changePanel: (panel: "annotations" | "ordinary" | "colors") => void;
  ...
  for (let i = 1; i <= 9; i++) {
    numberButtons.push(
      <Button
        ...
        style={
          numCounts[i.toString()] < 9
            ? numberButtonStyle
            : { ...numberButtonStyle, color: "black" }
        }
      />
    );
  }
  ...
  return (
    ...
    >
      ...
      >
        <Button
          label={String.fromCharCode(0x2151)}
          onClick={() => changePanel("annotations")}
          style={
            panelStatus === "annotations"
        ...
        <Button
          label="1"
          onClick={() => changePanel("ordinary")}
          style={
            panelStatus === "ordinary"
              ? activeControlButtonStyle
              : controlButtonStyle
          }
        />
        <Button
          label={String.fromCharCode(0xd83c, 0xdf08)}
          onClick={() => changePanel("colors")}
          style={
            panelStatus === "colors"
              ? activeControlButtonStyle
              : controlButtonStyle
      ...
      <div style={{ display: "flex", alignItems: "center", marginTop: "10px" }}>
        <Button
          ...
          onClick={() =>
            focusedCell
              ? handleCellChange(focusedCell[0], focusedCell[1], "")
              : null
          }
